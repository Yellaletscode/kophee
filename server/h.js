const list = [
  ...
  },
  {
    ...
    data: [
      {
        id: 8,
        title: 'Air Jordan 1 High OG "Chicago"', // Assuming this is the Jordan 1
        model: "Air Jordan 1",
        color: "Red, White, Black",
        price: 44.5,
      ...
      {
        id: 9,
        title: "Air Jordan (Specify Model)", // Modify title with specific model name
        model: "Jordan", // Update with specific model name (e.g., Air Jordan 3, Air Jordan 4)
